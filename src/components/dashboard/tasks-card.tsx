...
const TasksCard = () => {
  ...
  const handleInputChange = (taskId: string, field: keyof Task, value: any) => {
    ...
    if (['urgency', 'importance', 'duration'].includes(field)) {
                      ...
                      {isEditing ? (
                        <div className="grid gap-2" onClick={(e) => e.stopPropagation()}>
                          ...
                          <div className="grid grid-cols-2 lg:grid-cols-5 gap-2">
                            ...
                            <Input type="number" placeholder="Duration (hr)" value={task.duration ?? ''} onChange={(e) => handleInputChange(task.id, 'duration', e.target.value)} />
                        ...
                        <div className={cn("grid gap-2", task.completed ? 'line-through' : '')}>
                          ...
                          <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-1 text-xs">
                            ...
                            <p><span className="font-semibold text-muted-foreground">Duration:</span> {task.duration || 'N/A'} hours</p>
                            <p>
                            ...
                            <p className="col-span-full lg:col-span-1">
